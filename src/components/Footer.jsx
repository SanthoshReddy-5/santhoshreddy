    ...
    <div className="bg-[#1f1f2e] py-8 w-full">
      <div className="max-w-[1280px] mx-auto flex flex-col justify-center items-center px-4">
        ...
        <h2 className="text-[16px] md:text-[24px] font-bold text-purple-500 text-center">
          Velagala Jaya Naga Santhosh Reddy
        </h2>
        ...
        <div className="flex flex-wrap items-center justify-center mt-4 gap-4 sm:gap-6 md:gap-8">
          <a href="https://www.linkedin.com/in/santhosh-reddy-6a977a2ba" className="text-white hover:text-purple-500 transition duration-300">
            <FaLinkedin className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8" />
          </a>
          <a href="https://github.com/SanthoshReddy-5" className="text-white hover:text-purple-500 transition duration-300">
            <FaGithub className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8" />
          </a>
          <a href="https://leetcode.com" className="text-white hover:text-purple-500 transition duration-300">
            <SiLeetcode className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8" />
          </a>
          <a href="https://instagram.com/santhosh__reddy__5" className="text-white hover:text-purple-500 transition duration-300">
