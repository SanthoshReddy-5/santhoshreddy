...
const EducationDetails = () => {
  ...
  return (
    <div id='education' className="w-full bg-gradient-to-br from-green-100 via-white to-blue-100">
      ...
      <h2 className="text-[30px] md:text-[35px] font-medium text-center mb-6 text-purple-500 pt-[15px]">Educational Details</h2>
        <div className="mx-[20px] flex items-center flex-col">
          {educationData.map((edu, index) => (
            <div key={index} className="mb-6 p-4 w-[90%] md:w-1/2 bg-[#1f1f2e] rounded-[10px] shadow-md border-2 border-blue-500">
